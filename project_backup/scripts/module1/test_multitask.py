...
def test():
    ...
    # ==================== ĐƯỜNG DẪN ====================
    model_path      = os.path.join(project_root, 'checkpoints','Module#1 ver 2.4', 'best_multitask_model.pth')
    threshold_path  = os.path.join(project_root, 'checkpoints', 'Module#1 ver 2.4','emotion_thresholds.json')
